...
namespace Fenix {
    ...
    public:
        ...
        void SetPerspective(float vertical_fov, float z_near, float z_far);
        void SetViewportSize(uint32_t width, uint32_t height);

        float GetPerspectiveVertFOV() const { return m_PerspectiveFOV; }
        void SetPerspectiveVertFOV(float fov) { m_PerspectiveFOV = fov; RecalculateProjection(); }
